...
def show_homework():
    ...
    homework_window.title("کارخانگي")
...
root = tk.Tk()
root.title("برنامه ذخيره کارخانگي")

button_show_homework = tk.Button(root, text="نمايش کارخانگي", command=show_homework)
button_show_homework.pack()

button_save_homework = tk.Button(root, text="ذخيره کارخانگي", command=save_homework)
button_save_homework.pack()

label_homework_title = tk.Label(root, text="عنوان:")
label_homework_title.pack()

entry_homework_title = tk.Entry(root)
entry_homework_title.pack()

label_homework_description = tk.Label(root, text="توضیحات:")
